...
| Branch | Commits |
|--------|---------|
| `002-phase1-production-env` | 1. Add Pydantic state and AgentState in src/state.py (Evidence, JudicialOpinion, CriterionResult, AuditReport, reducers) 2. Add pyproject.toml and uv lock 3. Add .env.example and document LangSmith (LANGCHAIN_TRACING_V2) |
